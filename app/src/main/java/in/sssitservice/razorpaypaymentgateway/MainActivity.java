package in.sssitservice.razorpaypaymentgateway;
...
public class MainActivity extends AppCompatActivity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkout.setKeyID("<YOUR SECRET KEY FROM RAZORPAY DASHBOARD>");
        try {
    ...
    public void onPaymentSuccess(String s, PaymentData paymentData) {
        ...
        Log.w("orderid", paymentData.getOrderId());
        Log.w("onPaymentSuccess", s);
